...
describe('characterStore', () => {
  ...
  it('sets generated character to null and back', () => {
    ...
    const char = {
      ...
      personality: '',
      hooks: [],
      inventory: [{ id: 'item-1', name: 'Spellbook', quantity: 1, item_type: ItemType.TOOL, properties: {}, description: '', weight: 3, value: 25 }],
      equipped_items: [],
      resources: { hp: { value: 8, max: 8, short_rest_recovery: '1d6', long_rest_recovery: 'full' } },
      gold: 20,
      xp: 0,
      created_at: '2024-01-01',
    }
  ...
  it('reset restores ALL fields to initial values', () => {
    ...
    state.setCurrentCharacter({
      ...
      personality: '',
      hooks: [],
      inventory: [{ id: 'item-1', name: 'Dagger', quantity: 1, item_type: ItemType.WEAPON, properties: {}, description: '', weight: 1, value: 2 }],
      equipped_items: [],
      resources: { hp: { value: 30, max: 30, short_rest_recovery: '1d8', long_rest_recovery: 'full' } },
      gold: 50,
      xp: 100,
